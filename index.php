...
<title>时光导航</title>
<meta name="keywords" content="时光导航"/>
<meta name="description" content="时光导航，一个简简单单的网址导航。"/>
    ...
    <div class="left-bar">
        ...
        <div class="menu" id="menu">
            <ul class="scrollcontent">
                <!-- Left Nav -->
                <li><a href="https://t.me/xiaowansm" target="_blank">Telegram群</a></li>
                <?php
            ...
            <div class="container">
                <div class="rwo">
                    <div class="col-md-12">
                     ...
                     ©2023 Copyright
                                     <a class="nav-link" href="https://blog.wwang.pw/" target="_blank">
                    <i class="fa fa-heart" style="color:#9932CC;" aria-hidden="true"></i>时光's Blog</a>
                    </p>
                    </div>
                </div>
            </div>
